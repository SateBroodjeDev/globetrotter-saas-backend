...
const { validateJoi, checklistSchema } = require('../middleware/validation');
...
// Add checklist
router.post('/', authenticate, requireWorkspaceAccess(), validateJoi(checklistSchema), asyncHandler(async (req, res) => {
